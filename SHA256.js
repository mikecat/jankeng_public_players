...
PlayerName="SHA256"
【感想・作戦・工夫した点など】
相手のこれまでの手をSHA256でハッシュした結果により、自分の次の手を決定します。
*/
...
function sha256addOneDataBlock(data) {
  var W=new Array(64);
...
function sha256addData(data,dataSize) {
...
function sha256finish(data,dataSize) {
  var sha256=new Array(32);
  var i;
  var leftLen;
  var leftPtr;
...
function play(h)
{
  var sum = 0;
  sha256init();
  var hash = sha256finish(h[1],h[1].length);
